...
describe('formatDate', () => {
    it('should return `00:00` for `2017-05-03T00:00:00.000Z`', () => {
        const actual = formatDate("2017-05-03T00:00:00.000Z");

        assert.equal(actual, "00:00");
    });


    it('should return `вчера в 23:59` for `2017-05-02T23:59:59.999Z`', () => {
        const actual = formatDate("2017-05-02T23:59:59.999Z");
