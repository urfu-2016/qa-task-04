...
describe('formatDate', () => {
    describe('black box', () => {
        let clock;
        beforeEach(() => {
            clock = sinon.useFakeTimers(Date.parse('2017-04-26T23:59:59Z'));
        });
        afterEach(() => {
            clock.restore();
        });
        // Текущая дата имитирована следующая: 2017-04-26T23:59:59+05:00
        it(`should return '09:40' for 2017-04-26T14:40:10+05:00`,
            runSuccessTest('2017-04-26T14:40:10+05:00', '09:40'));
        it(`should return 'вчера в 16:40' for 2017-04-25T14:40:10-02:00`,
            runSuccessTest('2017-04-25T14:40:10-02:00', 'вчера в 16:40'));
        ...
        it(`should return '23:59' for 2017-04-26T23:59:59Z`,
            runSuccessTest('2017-04-26T23:59:59Z', '23:59'));
        it(`should return '00:00' for 2017-04-26T00:00:00Z`,
            runSuccessTest('2017-04-26T00:00:00Z', '00:00'));
