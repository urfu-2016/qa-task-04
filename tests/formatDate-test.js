...
describe('formatDate', () => {
    ...
    describe('Poitive tests', () => {
        ...
        describe('"hh:mm" format', () => {
            ...
            it('should return hh:mm for 00:00 today',
                runSuccessTest(nowDate, new Date(2017, 4, 1, 0, 0), '00:00'));
            it('should return hh:mm for 24:00 yesterday',
                runSuccessTest(nowDate, new Date(2017, 3, 30, 24, 0), '00:00'));
        });
        describe('"вчера в hh:mm" format', () => {
            ...
            it('should return hh:mm for 00:00 yesterday',
                runSuccessTest(nowDate, new Date(2017, 3, 29, 24, 0), 'вчера в 00:00'));
        });
        ...
        describe('"dd month в hh:mm" format', () => {
            ...
            it('should return hh:mm for the first of January this year',
                runSuccessTest(nowDate, new Date(2017, 0, 1, 0, 0), '1 января в 00:00'));
        });
